                        ...
                        <div className="relative z-10 max-w-4xl -top-32 -left-2 md:-top-12 md:-left-8">
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-10">
                                ...
                                <button 
                                    ...
                                    className="bg-[#FF6600] hover:bg-[#E65A00] text-white font-bold py-4 px-8 md:py-5 md:px-10 rounded-2xl transition-all shadow-xl shadow-orange-500/10 active:scale-95 whitespace-nowrap text-[16px] md:text-[18px]"
                                >
                                    Join waitlist
                                </button>
                            </div>
